...
let calendarSettings = {
    ...
    "epochgeo": {
        ...
        "holidays": new Map([
            ...
            [new Date(2026, 1, 16),   { "name": "Presidents' Day" }],
            [new Date(2026, 4, 25),   { "name": "Memorial Day" }],
            [new Date(2026, 5, 19),   { "name": "Juneteenth" }],
            [new Date(2026, 6, 3),    { "name": "Independence Day (observed)" }],
            [new Date(2026, 8, 7),    { "name": "Labor Day" }],
            [new Date(2026, 9, 12),   { "name": "Indigenous Peoples' Day" }],
            [new Date(2026, 10, 11),  { "name": "Veterans Day" }],
            [new Date(2026, 10, 26),  { "name": "Thanksgiving Day" }],
            [new Date(2026, 10, 27),  { "name": "EG Company Holiday - Day After Thanksgiving" }],
            [new Date(2026, 11, 24),  { "name": "Christmas Eve - EG Company Holiday" }],
            [new Date(2026, 11, 25),  { "name": "Christmas Day" }],
            [new Date(2026, 11, 31),  { "name": "New Year's Eve - EG Company Holiday" }],
        ].map(([d, v]) => [d.toDateString(), v]))
    }
}
